package net.seyarada.pandeloot.nms.v1_21_R1;
...
public class V1_21_R1 implements NMSMethods {
    ...
    public List<Entity> hologram(int duration, Location location, Player player, List<String> text, JavaPlugin plugin) {
        ...
        for (String msg : text) {
            ...
            ClientboundAddEntityPacket packetPlayOutSpawnEntity = new ClientboundAddEntityPacket(displayEntity, 1, displayEntity.blockPosition());
    ...
    public void displayToast(Player player, String title, String frame, org.bukkit.inventory.ItemStack icon) {
        ResourceLocation minecraftKey = ResourceLocation.fromNamespaceAndPath("pandeloot", "notification");
        ...
        AdvancementRewards reward = new AdvancementRewards(0, List.of(), List.of(), null);
    ...
    net.minecraft.network.Connection getConnectionWithReflection(Player player) {
        ...
        try {
            // "e" is the "connection" variable
            Field connectionField = ((CraftPlayer) player).getHandle().connection.getClass().getDeclaredField("e");
